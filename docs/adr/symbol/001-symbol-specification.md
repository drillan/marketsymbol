...
- `XJPX:NKM:20250314:F` - 日経225mini先物 2025年3月限（3/14 SQ）
- `XJPX:N225O:20250314:C:42000` - 日経225オプション Call 42,000円
- `XJPX:N225MW:20250110:P:39000` - 日経225ミニオプション 2025年1月10日限 Put 39,000円
...
> **Note**: 限月フォーマットは [ADR-002](./002-weekly-expiry-format.md) により `YYYYMMDD`（8桁）形式に統一されました。以下の表は歴史的参考として残しています。

| 形式 | 例 | 用途 | 備考 |
|------|-----|------|------|
| ~~`YYYYMM`~~ | ~~202503~~ | ~~標準月次限月~~ | **非推奨**: ADR-002により廃止 |
| ~~`YYYYMM-W`~~ | ~~202501-2~~ | ~~週次限月（第N週）~~ | **非推奨**: ADR-002により廃止 |
| `YYYYMMDD` | 20250314 | **全ての限月** | 統一形式（ADR-002で採用） |
...
"NK:20250314:F" → "XJPX:NK:20250314:F"

# marketsymbol → derivatives-reaper
"XJPX:NK:20250314:F" → "NK:20250314:F"
```
...
| 先物 | `XJPX:[商品]:[限月]:F` | `XJPX:NK:20250314:F` |
| オプション | `XJPX:[商品]:[限月]:[C/P]:[行使価格]` | `XJPX:N225O:20250314:C:42000` |
| 米国株 | `XNYS:[ティッカー]` | `XNYS:AAPL` |

> **Note**: 限月は全て `YYYYMMDD`（8桁）形式。詳細は [ADR-002](./002-weekly-expiry-format.md) を参照。
